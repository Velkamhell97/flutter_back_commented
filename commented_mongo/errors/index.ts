...
//->Interfaz del error, puede llevar otra llave
...
//->Parametros de entrada de la funcion que muestra el error
export interface ErrorParams {
  type : AppError, //->Tipo
  error ?: any, //->Error devuelvto en los try
  res : Response, //->res para responder
  [futureKey:string] : any //otro valor adicional pasado desde afuera de la funcion
}

//->Error generico que devuelve todo lo necesario de un error por la res
...
//->Objetos para cada tipo de error (como un enum)
export const errorTypes: Record<ErrorTypes, AppError> ={
  ...
  missing_files: { 
    msg: 'There are some missing files that are expected',
    name: 'MISSING_FILES_ERROR',
    code: 400, 
  },
